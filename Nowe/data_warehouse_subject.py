...
# path = '/home/student/Documents/python_program/subject.csv' #   path to directory (Linux)
path = 'C:/Users/Joseph/Documents/db_warehouse_script/subject.csv' #   path to directory (Windows)
